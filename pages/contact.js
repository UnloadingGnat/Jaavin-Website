...
export const Card2 = () => (
  <Card css={{ w: "100%" }}>
    ...
    <Card.Image src="email.webp" width="100%" height={340} objectFit="cover" />
  </Card>
);
...
export const Card3 = () => (
  <Card css={{ bg: "$black", w: "100%" }}>
    ...
    <Card.Image src="resume.webp" width="100%" height={340} objectFit="cover" />
  </Card>
);
          ...
          <div className={styles.header}>
            <div className={styles.headertext}>
              ...
              <Text
                ...
                weight="bold"
              >
                Feel free to contact me for any offers, questions, and
                inquiries.
              </Text>
            </div>
          </div>
