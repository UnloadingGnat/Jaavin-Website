...
export const CardInverse = () => (
  <Card css={{ w: "100%", h: "400px" }}>
    ...
    <Card.Body css={{ p: 0 }}>
      <Card.Image src="1325.jpg" objectFit="cover" width="100%" height="100%" />
    </Card.Body>
    <Card.Footer
      isBlurred
      css={{
          ...
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={12}>
                Oversaw the implementation of software systems for a 120lb
                competitive robot.
              </Text>
            </Col>
          </Row>
        ...
        <Col>
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={14}>
                Building an Ethereum fraud detector using convolutional neural
                networks.
              </Text>
            </Col>
          </Row>
        ...
        <Col>
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={14}>
                Started a club to promote the study and implementation of
                Blockchain.
              </Text>
            </Col>
          </Row>
...
export const Huff = () => (
  <Card css={{ w: "100%", h: "400px" }}>
    ...
    <Card.Body css={{ p: 0 }}>
      <Card.Image src="huff.png" objectFit="cover" width="100%" height="100%" />
    </Card.Body>
    <Card.Footer
      isBlurred
      css={{
        ...
        <Col>
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={14}>
                Developed the documentation website, used by over 5 thousand
                active users.
              </Text>
            </Col>
          </Row>
...
export const Irc = () => (
  <Card css={{ w: "100%", h: "400px" }}>
    ...
    <Card.Body css={{ p: 0 }}>
      <Card.Image src="cmd.png" objectFit="cover" width="100%" height="100%" />
    </Card.Body>
    <Card.Footer
      isBlurred
      css={{
        ...
        <Col>
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={14}>
                Only solo winner of an award in a hackathon with 430
                participants.
              </Text>
            </Col>
          </Row>
        ...
        <Col>
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={12}>
                Representing ~1000 engineering 1 students; consulted to review
                the program.
              </Text>
            </Col>
          </Row>
        ...
        <Col>
          <Row>
            <Col>
              ...
              <Text color="#d1d1d1" size={14}>
                Invited to Canada&apos;s most prestigious undergrad AI
                conference
              </Text>
            </Col>
          </Row>
